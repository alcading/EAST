...
<@CommonQueryMacro.page title="对公信贷分户账明细">
<table align="left"><tr><td>
<@CommonQueryMacro.CommonQuery id="EastDgxdfhzmxjl" init="true" submitMode="current">
<table width="1300px">
	<tr>
		<td colspan="2" valign="top">
			<@CommonQueryMacro.Interface id="interface" label="对公信贷分户账明细记录" />
		</td>
	</tr>
	<tr>
	...
	<tr>
		<td colspan="2">
			<@CommonQueryMacro.DataTable id="datatable1"  fieldStr="dkzh[80],zhmc[100],xdjjh[60],mxkmmc[60],jylx[80],jyje[40],zhye[40],hxjyrq[60],hxjysj[50],cjrq[50],operation[100]"  width="100%" hasFrame="true"/>
		</td>
	</tr>
	<tr>
      	<td colspan="2">
...
<script language="JavaScript">
	...
	function locate(id) {
		...
		if(record) {
			EastDgxdfhzmxjl_dataset.setRecord(record);
		}
	}
	//系统刷新单元格
	...
	function signWindow_floatWindow_beforeClose(subwindow) {
		EastDgxdfhzmxjl_dataset.cancelRecord();
		return true;
	}
	...
	function btModOrAdd_onClickCheck(button) {
		var id = EastDgxdfhzmxjl_dataset.getValue("id");
		if(id == null || "" == id ) {
			alert("字段[内部机构号]不能为空");
			return false;
		}
	...
	function flushCurrentPage() {
		EastDgxdfhzmxjl_dataset.flushData(EastDgxdfhzmxjl_dataset.pageIndex);
	}
</script>
