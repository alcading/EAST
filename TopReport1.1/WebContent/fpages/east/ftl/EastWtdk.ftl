...
<@CommonQueryMacro.page title="委托贷款">
<table align="left"><tr><td>
<@CommonQueryMacro.CommonQuery id="EastWtdk" init="true" submitMode="current">
<table width="1300px">
	<tr>
		<td colspan="2" valign="top">
			<@CommonQueryMacro.Interface id="interface" label="委托贷款" />
		</td>
	</tr>
	<tr>
	...
	<tr>
		<td colspan="2">
			<@CommonQueryMacro.DataTable id="datatable1"  fieldStr="xdjjh[40],xdhth[40],khtybh[40],yxjgdm[40],syrmc[60],wtjjzh[40],sjwtdkje[40],cjrq[30],operation[40]"  width="100%" hasFrame="true"/>
		</td>
	</tr>
	<tr>
      	<td colspan="2">
