...
<table width="1300px">
	...
	<tr>
		<td colspan="2">
			<@CommonQueryMacro.DataTable id="datatable1"  fieldStr="id[60],gh[60],yxjgdm[100],nbjgh[100],jrxkzh[110],yxjgmc[300],gylx[100],gyyhjb[100],gyqxjb[100],sgrq[60],gwzt[60],operation[100]"  width="100%" hasFrame="true"/>
		</td>
	</tr>
	<tr>
      	<td colspan="2">
      		<@CommonQueryMacro.FloatWindow id="signWindow" label="" width="900px" height="480px" resize="true" defaultZoom="normal" minimize="false" maximize="false" closure="true" float="true" exclusive="true" position="center" show="false" >
      			<div align="center">
        			  ...
        			  fieldStr="id,gh,yxjgdm,nbjgh,zxjgdm,jrxkzh,yxjgmc,gylx,sfstgy,khjlbz,jbzwbz,qxglbz,xdybz,kgybz,zhgybz,sqbz,sqfw,gwbh,gyyhjb,gyqxjb,sgrq,gwzt,cjrq" colNm=4/>
        			<br/>
...
window.onload=function(){
	...
	function openModifyWindow(id,flag) {
		locate(id);
		if(flag==1){
		EastGyb_dataset.setFieldReadOnly("id",true);
		$("#btModOrAdd").get(0).style.display="";
		}
