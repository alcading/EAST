...
<@CommonQueryMacro.page title="信贷合同表">
<table align="left"><tr><td>
<@CommonQueryMacro.CommonQuery id="EastXdhtb" init="true" submitMode="current">
<table width="1300px">
	<tr>
		<td colspan="2" valign="top">
			<@CommonQueryMacro.Interface id="interface" label="信贷合同表" />
		</td>
	</tr>
	<tr>
	...
	<tr>
		<td colspan="2">
			<@CommonQueryMacro.DataTable id="datatable1"  fieldStr="xdhth[40],zhth[40],khtybh[40],khmc[30],cpmc[60],xdywzl[40],jzll[30],llfd[30],cjrq[30],operation[40]"  width="100%" hasFrame="true"/>
		</td>
	</tr>
	<tr>
      	<td colspan="2">
      		<@CommonQueryMacro.FloatWindow id="signWindow" label="" width="900px" height="480px" resize="true" defaultZoom="normal" minimize="false" maximize="false" closure="true" float="true" exclusive="true" position="center" show="false" >
      			<div align="center">
        			  ...
        			  fieldStr="xdhth,zhth,khtybh,yxjgdm,jrxkzh,nbjgh,khmc,cpmc,dkxgzl,xdywzl,bz,je,htydrq,htdqrq,lllx,jzll,llfd,zydbfs,ghjlgh,dkqx,fkfs,zjly,dkyt,dktxdq,dktxxy,sfgjxzxy,cjrq" colNm=4/>
        			<br/>
