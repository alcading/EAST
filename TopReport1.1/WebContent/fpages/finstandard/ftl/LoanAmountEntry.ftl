...
<@CommonQueryMacro.page title="LoanAmountEntry.title">
   ...
   <tr>
      <td>
      	<@CommonQueryMacro.CommonQuery id="LoanAmountEntry" init="true" submitMode="current">
      		<table width="100%">
      			<tr>
...
<script language="javascript">
	...
	window.onload=function(){
		...
		if(sjrq != null){
			LoanAmountEntry_interface_dataset.setValue("sjrq", sjrq);
		} else {
	    	LoanAmountEntry_interface_dataset.setValue("sjrq", currentDate);
		}
