...
public abstract class BaseEastDghqckfhzmxjl implements java.io.Serializable {
	...
	/** default constructor */
	public BaseEastDghqckfhzmxjl() {
	}

	/** minimal constructor */
	public BaseEastDghqckfhzmxjl(EastDghqckfhzmxjlId id) {
		this.id = id;
	}

	/** full constructor */
	public BaseEastDghqckfhzmxjl(EastDghqckfhzmxjlId id, String khtybh, String yxjgdm, String jrxkzh, String nbjgh,
			...
			String sqgyh, String zy, String cbmbz, String jyjdbz) {
		this.id = id;
		this.khtybh = khtybh;
		this.yxjgdm = yxjgdm;
		this.jrxkzh = jrxkzh;
