...
/**
 * AbstractEastGrxdfhzmxjlTmp entity provides the base persistence definition
 * of the EastGrxdfhzmxjlTmp entity. @author MyEclipse Persistence Tools
 */

public abstract class BaseEastGrxdfhzmxjl implements java.io.Serializable {
	...
	/** default constructor */
	public BaseEastGrxdfhzmxjl() {
	}

	/** minimal constructor */
	public BaseEastGrxdfhzmxjl(EastGrxdfhzmxjlId id) {
		this.id = id;
	}
	...
	public EastGrxdfhzmxjlId getId() {
		return this.id;
	}

	public void setId(EastGrxdfhzmxjlId id) {
		this.id = id;
	}
