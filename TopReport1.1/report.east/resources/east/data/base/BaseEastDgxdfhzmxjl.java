...
/**
 * AbstractEastDgxdfhzmxjlTmp entity provides the base persistence definition of
 * the EastDgxdfhzmxjlTmp entity. @author MyEclipse Persistence Tools
 */

public abstract class BaseEastDgxdfhzmxjl implements java.io.Serializable {
	...
	/** default constructor */
	public BaseEastDgxdfhzmxjl() {
	}

	/** minimal constructor */
	public BaseEastDgxdfhzmxjl(EastDgxdfhzmxjlId id) {
		this.id = id;
	}

	// Property accessors

	public EastDgxdfhzmxjlId getId() {
		return this.id;
	}

	public void setId(EastDgxdfhzmxjlId id) {
		this.id = id;
	}
