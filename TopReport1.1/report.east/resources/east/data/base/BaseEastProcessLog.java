...
public class BaseEastProcessLog implements Serializable {
	...
	// Fields
		...
		public boolean equals (Object obj) {
			...
			if (!(obj instanceof resources.east.data.pub.EastProcessLog)) return false;
			else {
				resources.east.data.pub.EastProcessLog eastProcessLog = (resources.east.data.pub.EastProcessLog) obj;
