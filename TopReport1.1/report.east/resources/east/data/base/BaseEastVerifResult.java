...
public class BaseEastVerifResult implements Serializable {
	...
	private int hashCode = Integer.MIN_VALUE;
			...
			public boolean equals (Object obj) {
				...
				if (!(obj instanceof resources.east.data.pub.EastVerifResult)) return false;
				else {
					resources.east.data.pub.EastVerifResult eastVerifResult = (resources.east.data.pub.EastVerifResult) obj;
