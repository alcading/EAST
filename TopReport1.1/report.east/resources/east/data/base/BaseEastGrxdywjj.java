...
public class BaseEastGrxdywjj implements Serializable {

	/**
	 * 
	 */
	private static final long serialVersionUID = 7897173337433530607L;
	private EastGrxdywjjPK id;
	...
	/** default constructor */
	public BaseEastGrxdywjj() {
	}
	
	public BaseEastGrxdywjj(EastGrxdywjjPK id) {
		this.setId(id);
	}
	
	public EastGrxdywjjPK getId() {
		return id;
	}
	public void setId(EastGrxdywjjPK id) {
		this.id = id;
	}
	...
	public void setJkye(BigDecimal jkye) {
		this.jkye = jkye;
	}
	...
	public void setDksjffrq(String dksjffrq) {
		this.dksjffrq = dksjffrq;
	}
	...
	public void setDkysdqrq(String dkysdqrq) {
		this.dkysdqrq = dkysdqrq;
	}
	...
	public void setDksjdqrq(String dksjdqrq) {
		this.dksjdqrq = dksjdqrq;
	}
	...
	public void setBnqxye(BigDecimal bnqxye) {
		this.bnqxye = bnqxye;
	}
	...
	public void setXdyygh(String xdyygh) {
		this.xdyygh = xdyygh;
	}
	...
	public void setLjqkqs(Integer ljqkqs) {
		this.ljqkqs = ljqkqs;
	}
	...
	public void setLxqkqs(Integer lxqkqs) {
		this.lxqkqs = lxqkqs;
	}
	...
	public void setStzfbz(String stzfbz) {
		this.stzfbz = stzfbz;
	}
