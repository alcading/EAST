...
/**
 * AbstractEastDgxdfhz entity provides the base persistence definition of the
 * EastDgxdfhz entity. @author MyEclipse Persistence Tools
 */

public abstract class BaseEastDgxdfhz implements java.io.Serializable {
	...
	*/
	...
	/** default constructor */
	public BaseEastDgxdfhz() {
	}

	/** minimal constructor */
	public BaseEastDgxdfhz(EastDgxdfhzId id) {
		this.id = id;
	}

	public EastDgxdfhzId getId() {
		return id;
	}

	public void setId(EastDgxdfhzId id) {
		this.id = id;
	}
