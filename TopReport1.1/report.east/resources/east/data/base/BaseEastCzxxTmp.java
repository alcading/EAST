...
public abstract class BaseEastCzxxTmp implements java.io.Serializable {
	...
	/** default constructor */
	public BaseEastCzxxTmp() {
	}

	/** minimal constructor */
	public BaseEastCzxxTmp(EastCzxxTmpId id) {
		this.id = id;
	}

	/** full constructor */
	public BaseEastCzxxTmp(EastCzxxTmpId id, String hqckzh, String khtybh, String yxjgdm, String jrxkzh,
	...
	public boolean equals (Object obj) {
		...
		if (!(obj instanceof EastCzxxTmp)) return false;
		else {
			EastCzxxTmp eastCzxxTmpo = (EastCzxxTmp) obj;
			if (null == this.getId() || null == eastCzxxTmpo.getId()) return false;
			else return (this.getId().equals(eastCzxxTmpo.getId()));
		}
	}
