...
/**
 * AbstractEastGrdqckfhz entity provides the base persistence definition of the
 * EastGrdqckfhz entity. @author MyEclipse Persistence Tools
 */

public abstract class BaseEastGrdqckfhz implements java.io.Serializable {
	...
	*/
	...
	/** default constructor */
	public BaseEastGrdqckfhz() {
	}

	/** minimal constructor */
	public BaseEastGrdqckfhz(EastGrdqckfhzId id) {
		this.id = id;
	}

	// Property accessors

	public EastGrdqckfhzId getId() {
		return this.id;
	}

	public void setId(EastGrdqckfhzId id) {
		this.id = id;
	}

	public String getGrkhtybh() {
		return this.grkhtybh;
	}

	public void setGrkhtybh(String grkhtybh) {
		this.grkhtybh = grkhtybh;
	}
	...
	public String getGrdqckzhlx() {
		return this.grdqckzhlx;
	}

	public void setGrdqckzhlx(String grdqckzhlx) {
		this.grdqckzhlx = grdqckzhlx;
	}
