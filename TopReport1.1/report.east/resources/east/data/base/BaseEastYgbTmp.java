...
public class BaseEastYgbTmp implements Serializable {
	...
	/** default constructor */
	public BaseEastYgbTmp() {
	}
	
	public BaseEastYgbTmp(EastYgbPK id) {
		this.setId(id);
	}
	...
	/** full constructor 
	 * @return */
	public  BaseEastYgbTmp(EastYgbPK id,String yxjgdm, String jrxkzh, String yxjgmc, String xm, String sfzh, String lxdh,
			String wdh, String ssbm, String zw, String ygzt, String gwbh, String cjrq,String errmsg) {
		this.setId(id);
		this.yxjgdm = yxjgdm;
		this.jrxkzh = jrxkzh;
		this.yxjgmc = yxjgmc;
	...
	public boolean equals (Object obj) {
		...
		if (!(obj instanceof EastYgbTmp)) return false;
		else {
			EastYgbTmp eastYgbTmp= (EastYgbTmp) obj;
			if (null == this.getId() || null == (eastYgbTmp).getId()) return false;
			else return (this.getId().equals(eastYgbTmp.getId()));
		}
	}
