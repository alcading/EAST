...
/**
 * AbstractEastGrdqckfhzmxjlTmp entity provides the base persistence definition
 * of the EastGrdqckfhzmxjlTmp entity. @author MyEclipse Persistence Tools
 */

public abstract class BaseEastGrdqckfhzmxjl implements java.io.Serializable {
	...
	private EastGrdqckfhzmxjlId id;
	...
	/** default constructor */
	public BaseEastGrdqckfhzmxjl() {
	}

	/** minimal constructor */
	public BaseEastGrdqckfhzmxjl(EastGrdqckfhzmxjlId id) {
		this.id = id;
	}

	// Property accessors

	public EastGrdqckfhzmxjlId getId() {
		return this.id;
	}

	public void setId(EastGrdqckfhzmxjlId id) {
		this.id = id;
	}
