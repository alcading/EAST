...
public class BaseEastZcfzkmtjbPK implements Serializable {
	...
	public BaseEastZcfzkmtjbPK() {}


	public BaseEastZcfzkmtjbPK(String nbjgh, String tjkmbh, String qxlx, String tjrq, String bz, String cjrq) {
		this.nbjgh = nbjgh;
		this.tjkmbh = tjkmbh;
		this.qxlx = qxlx;
		this.tjrq = tjrq;
	...
	public boolean equals (Object obj) {
		...
		if (!(obj instanceof resources.east.data.pub.EastZcfzkmtjbPK)) return false;
		else {
			resources.east.data.pub.EastZcfzkmtjbPK mObj = (resources.east.data.pub.EastZcfzkmtjbPK) obj;
