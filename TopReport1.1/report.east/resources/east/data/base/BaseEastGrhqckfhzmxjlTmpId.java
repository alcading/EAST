...
public abstract class BaseEastGrhqckfhzmxjlTmpId implements java.io.Serializable {
	...
	/** default constructor */
	public BaseEastGrhqckfhzmxjlTmpId() {
	}

	/** full constructor */
	public BaseEastGrhqckfhzmxjlTmpId(String hxjylsh, String zjylsh, Integer bcxh, String hqckzh, String hxjyrq,
			String cjrq) {
	...
	public boolean equals(Object other) {
		...
		if ((other == null))
			return false;
		if (!(other instanceof BaseEastGrhqckfhzmxjlTmpId))
			return false;
		BaseEastGrhqckfhzmxjlTmpId castOther = (BaseEastGrhqckfhzmxjlTmpId) other;
