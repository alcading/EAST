...
public  class BaseEastDbgx implements java.io.Serializable {
	...
	/** minimal constructor */
	public BaseEastDbgx(EastDbgxId id) {
		this.id = id;
	}

	/** full constructor */
	public BaseEastDbgx(EastDbgxId id, String yxjgdm, String jrxkzh, String nbjgh, String dblx, BigDecimal dbje,
			String dbqsrq, String dbdqrq, String dbzt, String jldbygh) {
		this.id = id;
		this.yxjgdm = yxjgdm;
		this.jrxkzh = jrxkzh;
		this.nbjgh = nbjgh;
