...
public abstract class BaseEastGrxdfhzId implements java.io.Serializable {
	...
	*/
	...
	/** default constructor */
	public BaseEastGrxdfhzId() {
	}

	/** full constructor */
	public BaseEastGrxdfhzId(String dkfhzh, String bz, String xdjjh, String cjrq) {
		this.dkfhzh = dkfhzh;
		this.bz = bz;
		this.xdjjh = xdjjh;
		this.cjrq = cjrq;
