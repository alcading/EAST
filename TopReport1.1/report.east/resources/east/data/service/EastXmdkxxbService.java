 ...
 *
 */
public class EastXmdkxxbService {
	// 根据查询hql语句进行分页查询
		...
		public static EastXmdkxxbService getInstance() {
			return (EastXmdkxxbService) ApplicationContextUtils.getBean("EastXmdkxxbService");
		}
		...
		public Iterator selectByid(String id) {
			...
			try {
				return rootDAO.queryByQL("from EastXmdkxxb A where A.id='" + id + "'");
		...
		// 通过id来获取实体类
		public EastXmdkxxb selectById(String id) {
			ROOTDAO rootdao = ROOTDAOUtils.getROOTDAO();
			EastXmdkxxb eastXdhtb = null;
			try {

				eastXdhtb = (EastXmdkxxb) rootdao.query(EastXmdkxxb.class, id);
		 ...
		 */
		public void removeEntity(EastXmdkxxb eastXmdkxxb) {
			ROOTDAO rootDAO = ROOTDAOUtils.getROOTDAO();
			try {
		...
		public void addEntity(EastXmdkxxb eastXmdkxxb) throws CommonException {
			ROOTDAO rootDAO = ROOTDAOUtils.getROOTDAO();
		...
		public void modEntity(EastXmdkxxb eastXmdkxxb) {
			ROOTDAO rootDAO = ROOTDAOUtils.getROOTDAO();
			try {
		...
		public boolean isExists(EastXmdkxxbPK id) {
			ROOTDAO rootDAO = ROOTDAOUtils.getROOTDAO();
			try {
