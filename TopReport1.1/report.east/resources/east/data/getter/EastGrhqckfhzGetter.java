...
public class EastGrhqckfhzGetter extends BaseGetter {
	/*
	 * 获取员工列表
	 * @author luqh
	 */
	...
	public Result call() throws AppException {
	   ...
	   */
		private PageQueryResult getData() throws CommonException {
			...
			hql.append("from EastGrhqckfhz A where rownum<="+DBUtil.ROWNUM);
			...
			PageQueryResult pqr= EastGrhqckfhzService.getInstance().pageQueryByHql(pageIndex, pageSize, hql.toString());
			return pqr;
		}
}
