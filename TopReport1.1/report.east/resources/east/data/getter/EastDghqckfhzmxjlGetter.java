...
public class EastDghqckfhzmxjlGetter extends BaseGetter {
	...
	public Result call() throws AppException {
		try {
			...
			this.setValue2DataBus(ReportConstant.QUERY_LOG_BUSI_NAME, "对公活期存款分户账明细记录查询");
	   ...
	   */
		private PageQueryResult getData() throws CommonException {
			...
			PageQueryResult pqr= EastDghqckfhzmxjlService.getInstance().pageQueryByHql(pageIndex, pageSize, hql.toString());
			return pqr;
		}
}
