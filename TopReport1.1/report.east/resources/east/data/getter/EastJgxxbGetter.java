...
public class EastJgxxbGetter extends BaseGetter {
	/*
	 * 获取员工列表
	 * @author luqh
	 */
	 ...
	 * @throws CommonException 
	   */
	   private PageQueryResult getData() throws CommonException {
			...
			hql.append("from EastJgxxb A where rownum<="+DBUtil.ROWNUM);
			...
			PageQueryResult pqr= EastJgxxbService.getInstance().pageQueryByHql(pageIndex, pageSize, hql.toString());
			return pqr;
		}
}
