...
public class EastXmdkxxbGetter extends BaseGetter {
	/*
	 * 获取员工列表
	 * 
	 * @author luqh
	...
	public Result call() throws AppException {
		try {
			...
			this.setValue2DataBus(ReportConstant.QUERY_LOG_BUSI_NAME, "项目贷款信息表");
	...
	private PageQueryResult getData() throws CommonException {
	    ...
	    String xmmc = (String)para.get("xmmc");
		...
		PageQueryResult pqr = EastXmdkxxbService.getInstance().pageQueryByHql(pageIndex, pageSize, hql.toString());
		return pqr;
	}
}
