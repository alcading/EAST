...
public class EastDgbwsxywGetter extends BaseGetter {
	/*
	 * 获取列表
	 * 
	 * @author 
	...
	private PageQueryResult getData() throws CommonException {
		...
		hql.append("from EastDgbwsxyw A where rownum<="+DBUtil.ROWNUM);
		...
		PageQueryResult pqr = EastDgbwsxywService.getInstance().pageQueryByHql(pageIndex, pageSize, hql.toString());
		return pqr;
	}
}
