...
public class EastZcfzkmtjbGetter extends BaseGetter {
	/*
	 * 获取员工列表
	 * @author luqh
	 */
	...
	public Result call() throws AppException {
		try {
			...
			this.setValue2DataBus(ReportConstant.QUERY_LOG_BUSI_NAME, "资产负债科目统计表信息查询");
	...
	private PageQueryResult getData() throws CommonException {
		...
		hql.append("from EastZjjyxxb A where 1 = 1 ");
		...
		PageQueryResult pqr= EastZcfzkmtjbService.getInstance().pageQueryByHql(pageIndex, pageSize, hql.toString());
		return pqr;
	}
}
