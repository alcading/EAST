...
public class EastCzxxTmpGetter extends BaseGetter {
	/*
	...
	public Result call() throws AppException {
		try {
			...
			this.setValue2DataBus(ReportConstant.QUERY_LOG_BUSI_NAME, "存折信息不合规数据查询");
	   ...
	   private PageQueryResult getData() {
			...
			PageQueryResult pqr= EastCzxxTmpService.getInstance().pageQueryByHql(pageIndex, pageSize);
			return pqr;
		}
	}
