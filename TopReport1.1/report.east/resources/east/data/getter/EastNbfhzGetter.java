...
public class EastNbfhzGetter extends BaseGetter {
	/*
	 * 获取员工列表
	 * @author luqh
	 */
	...
	public Result call() throws AppException {
		try {
			...
			this.setValue2DataBus(ReportConstant.QUERY_LOG_BUSI_NAME, "内部分户账查询");
	   ...
	   */
		private PageQueryResult getData() throws CommonException {
			...
			hql.append("from EastNbfhz A where rownum<="+DBUtil.ROWNUM);
			...
			PageQueryResult pqr= EastNbfhzService.getInstance().pageQueryByHql(pageIndex, pageSize, hql.toString());
			return pqr;
		}
}
