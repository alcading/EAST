...
public class EastDgkhGetter extends BaseGetter {
	/*
	 * 获取员工列表
	 * 
	 * @author luqh
	...
	public Result call() throws AppException {
		try {
			...
			this.setValue2DataBus(ReportConstant.QUERY_LOG_BUSI_NAME, "对公客户信息查询");
	...
	private PageQueryResult getData() throws CommonException {
		...
		hql.append("from EastDgkh A where rownum<="+DBUtil.ROWNUM);
		...
		PageQueryResult pqr = EastDgkhService.getInstance().pageQueryByHql(pageIndex, pageSize, hql.toString());
		return pqr;
	}
}
