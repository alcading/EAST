...
public class EastDgdqckfhzmxjlGetter extends BaseGetter {
	/*
	 * 获取员工列表
	 * @author luqh
	 */
	...
	public Result call() throws AppException {
	   ...
	   */
		private PageQueryResult getData() throws CommonException {
			...
			hql.append("from EastDgdqckfhzmxjl A where rownum<="+DBUtil.ROWNUM);
			...
			PageQueryResult pqr= EastDgdqckfhzmxjlService.getInstance().pageQueryByHql(pageIndex, pageSize, hql.toString());
			return pqr;
		}
}
