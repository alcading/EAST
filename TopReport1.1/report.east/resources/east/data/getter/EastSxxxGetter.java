...
public class EastSxxxGetter extends BaseGetter {
	/*
	 * 获取列表
	 * 
	 * @author 
	...
	public Result call() throws AppException {
		try {
			...
			this.setValue2DataBus(ReportConstant.QUERY_LOG_BUSI_NAME, "授信信息");
	...
	private PageQueryResult getData() throws CommonException {
	    ...
	    String sxxyh = (String)para.get("sxxyh");
		...
		hql.append("from EastSxxx A where rownum<="+DBUtil.ROWNUM);
		
		if(StringUtils.isNotBlank(sxxyh)){
			hql.append(" and A.id.sxxyh = '"+sxxyh.trim()+"' ");
		}
		...
		PageQueryResult pqr = EastSxxxService.getInstance().pageQueryByHql(pageIndex, pageSize, hql.toString());
		return pqr;
	}
}
