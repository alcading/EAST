...
public class EastDgxdywjjGetter extends BaseGetter {
	/*
	 * 获取列表
	 * 
	 * @author 
	...
	public Result call() throws AppException {
		try {
			...
			this.setValue2DataBus(ReportConstant.QUERY_LOG_BUSI_NAME, "对公信贷业务借据");
	...
	private PageQueryResult getData() throws CommonException {
		...
		hql.append("from EastDgxdywjj A where rownum<="+DBUtil.ROWNUM);
		...
		PageQueryResult pqr = EastDgxdywjjService.getInstance().pageQueryByHql(pageIndex, pageSize, hql.toString());
		return pqr;
	}
}
