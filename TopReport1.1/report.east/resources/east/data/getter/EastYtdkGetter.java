...
public class EastYtdkGetter extends BaseGetter {
	/*
	 * 获取列表
	 * 
	 * @author 
	...
	public Result call() throws AppException {
		try {
			...
			this.setValue2DataBus(ReportConstant.QUERY_LOG_BUSI_NAME, "银团贷款");
	...
	private PageQueryResult getData() throws CommonException {
		...
		PageQueryResult pqr = EastYtdkService.getInstance().pageQueryByHql(pageIndex, pageSize, hql.toString());
		return pqr;
	}
}
