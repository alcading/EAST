...
public class EastGybGetter extends BaseGetter {
	/*
	 * 获取员工列表
	 * @author luqh
	 */
	 ...
	 * @throws CommonException 
	   */
	   private PageQueryResult getData() throws CommonException {
			...
			hql.append("from EastGyb A where 1 = 1 ");
			...
			PageQueryResult pqr= EastGybService.getInstance().pageQueryByHql(pageIndex, pageSize, hql.toString());
			return pqr;
		}
}
