...
public class EastDbgxTmpGetter extends BaseGetter {
	/*
	...
	public Result call() throws AppException {
		try {
			...
			this.setValue2DataBus(ReportConstant.QUERY_LOG_BUSI_NAME, "担保关系信息不合规数据查询");
	   ...
	   private PageQueryResult getData() {
			...
			PageQueryResult pqr= EastDbgxTmpService.getInstance().pageQueryByHql(pageIndex, pageSize);
			return pqr;
		}
	}
