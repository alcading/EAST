...
public class EastJjkxxGetter extends BaseGetter {
	/*
	 * 获取列表
	 * 
	 * @author 
	...
	public Result call() throws AppException {
		try {
			...
			this.setValue2DataBus(ReportConstant.QUERY_LOG_BUSI_NAME, "借记卡信息");
	...
	private PageQueryResult getData() throws CommonException {
		...
		hql.append("from EastJjkxx A where rownum<="+DBUtil.ROWNUM);
		...
		PageQueryResult pqr = EastJjkxxService.getInstance().pageQueryByHql(pageIndex, pageSize, hql.toString());
		return pqr;
	}
}
