...
public class EastGrdqckfhzmxjlGetter extends BaseGetter {
	/*
	 * 获取员工列表
	 * @author luqh
	 */
	   ...
	   */
		private PageQueryResult getData() throws CommonException {
		   ...
		   Map para = this.getCommQueryServletRequest().getParameterMap();
			...
			hql.append("from EastGrdqckfhzmxjl A where rownum<="+DBUtil.ROWNUM);
			...
			PageQueryResult pqr= EastGrdqckfhzmxjlService.getInstance().pageQueryByHql(pageIndex, pageSize, hql.toString());
			return pqr;
		}
}
