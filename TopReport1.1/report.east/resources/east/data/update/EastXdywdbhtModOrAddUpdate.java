...
import resources.east.data.operation.EastXdywdbhtOperation;
import resources.east.data.pub.EastXdywdbht;
import resources.east.data.pub.EastXdywdbhtPK;

public class EastXdywdbhtModOrAddUpdate extends BaseUpdate {

	/*
	 * 处理国家/地区代码维护的插入和更新,插入和更新给程序判定
	 */
	public final static String DATASET_ID = "EastXdywdbht";
	...
	public UpdateReturnBean saveOrUpdate(MultiUpdateResultBean multiUpdateResultBean, HttpServletRequest request,
		...
		try {
			...
			// 更新对象
			EastXdywdbht eastXdywdbht = new EastXdywdbht();
			EastXdywdbhtPK xdywdbhtpk = new EastXdywdbhtPK();
			// Operation参数
			...
			if (updateResultBean.hasNext()) {
				...
				xdywdbhtpk.setDbhth(dbhth);
				xdywdbhtpk.setZjhm(zjhm);
