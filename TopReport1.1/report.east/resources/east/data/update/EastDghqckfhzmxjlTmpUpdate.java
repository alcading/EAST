...
public class EastDghqckfhzmxjlTmpUpdate extends BaseUpdate {
	private static final HtLog htlog=HtLogFactory.getLogger(EastDghqckfhzmxjlTmpUpdate.class);
	private static final String DATASET_ID="EAST_DGHQCKFHZMXJL_TMP";
	...
	public UpdateReturnBean saveOrUpdate(MultiUpdateResultBean multiUpdateResultBean,
		...
		EastDghqckfhzmxjlTmp dghqckfhzmxjlTmp = new EastDghqckfhzmxjlTmp();
		EastDghqckfhzmxjl dghqckfhzmxjl = new EastDghqckfhzmxjl();
		EastDghqckfhzmxjlId dghqckfhzmxjlId = new EastDghqckfhzmxjlId();
		...
		//	Integer bcxh = (Integer) map.get("bcxh");
			...
			try{
				...
				ExceptionUtil.throwCommonException("更对公活期存款分户账明细记录信息失败");
			}
