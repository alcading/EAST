...
import resources.east.data.operation.EastXykxxOperation;
import resources.east.data.pub.EastXykxx;
import resources.east.data.pub.EastXykxxPK;

public class EastXykxxModOrAddUpdate extends BaseUpdate {

	/*
	 * 处理国家/地区代码维护的插入和更新,插入和更新给程序判定
	 */
	public final static String DATASET_ID = "EastXykxx";
	...
	public UpdateReturnBean saveOrUpdate(MultiUpdateResultBean multiUpdateResultBean, HttpServletRequest request,
		...
		try {
			...
			// 更新对象
			EastXykxx eastXykxx = new EastXykxx();
			EastXykxxPK xykxxpk = new EastXykxxPK();
			// Operation参数
