...
import resources.east.data.operation.EastLccpztbOperation;
import resources.east.data.pub.EastLccpztb;

public class EastLccpztbModOrAddUpdate extends BaseUpdate {
	private static final Logger logger = Logger.getLogger(EastLccpztbModOrAddUpdate.class);
	/*
	 * 处理国家/地区代码维护的插入和更新,插入和更新给程序判定
	 */
	public final static String DATASET_ID = "EastLccpztb";
	...
	public UpdateReturnBean saveOrUpdate(MultiUpdateResultBean multiUpdateResultBean, HttpServletRequest request,
		...
		try {
			...
			// 更新对象
			EastLccpztb eastLccpztb = new EastLccpztb();
			// Operation参数
