...
import resources.east.data.operation.EastYtdkOperation;
import resources.east.data.pub.EastYtdk;
import resources.east.data.pub.EastYtdkPK;

public class EastYtdkModOrAddUpdate extends BaseUpdate {

	/*
	 * 处理国家/地区代码维护的插入和更新,插入和更新给程序判定
	 */
	public final static String DATASET_ID = "EastYtdk";
	...
	public UpdateReturnBean saveOrUpdate(MultiUpdateResultBean multiUpdateResultBean, HttpServletRequest request,
		...
		try {
			...
			// 更新对象
			EastYtdk eastYtdk = new EastYtdk();
			EastYtdkPK ytdkpk = new EastYtdkPK();
			// Operation参数
