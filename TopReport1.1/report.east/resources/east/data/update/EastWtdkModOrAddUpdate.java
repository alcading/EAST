...
import resources.east.data.operation.EastWtdkOperation;
import resources.east.data.pub.EastWtdk;
import resources.east.data.pub.EastWtdkPK;

public class EastWtdkModOrAddUpdate extends BaseUpdate {

	/*
	 * 处理国家/地区代码维护的插入和更新,插入和更新给程序判定
	 */
	public final static String DATASET_ID = "EastWtdk";
	...
	public UpdateReturnBean saveOrUpdate(MultiUpdateResultBean multiUpdateResultBean, HttpServletRequest request,
		...
		try {
			...
			// 更新对象
			EastWtdk eastWtdk = new EastWtdk();
			EastWtdkPK wtdkpk = new EastWtdkPK();
			// Operation参数
