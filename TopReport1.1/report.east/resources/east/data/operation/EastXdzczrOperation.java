...
public class EastXdzczrOperation extends BaseOperation {

	public static final String ID = "EastXdzczrOperation";
	...
	public void execute(OperationContext context) throws CommonException {
		...
		eastXdzczrService.modEntity(eastXdzczr);
		
		/*if (CMD_INSERT.equalsIgnoreCase(cmd)) {
			eastXdzczrService.addEntity(eastXdzczr);
		} else if (CMD_UPDATE.equalsIgnoreCase(cmd)) {
			eastXdzczrService.modEntity(eastXdzczr);
		} else if (CMD_DELETE.equalsIgnoreCase(cmd)) {
			eastXdzczrService.removeEntity(eastXdzczr);
		}*/
	}
