...
public abstract class BaseWorkflowTaskPool  implements Serializable {
	 ...
	 * @param insertTime the INSERT_TIME value
	 */
	 ...
	 * @param assignFlag the ASSIGN_FLAG value
	 */
	 ...
	 * @param assignTime the ASSIGN_TIME value
	 */
	...
	public boolean equals (Object obj) {
		...
		if (!(obj instanceof com.huateng.ebank.entity.data.workflow.WorkflowTaskPool)) return false;
		else {
			...
			if (null == this.getId() || null == workflowTaskPool.getId()) return false;
			else return (this.getId().equals(workflowTaskPool.getId()));
		}
	}
